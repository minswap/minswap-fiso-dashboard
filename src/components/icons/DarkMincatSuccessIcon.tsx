...
export function DarkMincatSuccessIcon(): React.ReactElement {
  return (
    <svg
      height="220"
      viewBox="0 0 220 220"
    ...
    >
      <defs>
        <filter filterUnits="objectBoundingBox" height="280%" id="3fyl6e67sa" width="280%" x="-90%" y="-90%">
        ...
        <filter filterUnits="objectBoundingBox" height="141.4%" id="zyr90pzvkc" width="144.4%" x="-22.2%" y="-20.7%">
          <feOffset in="SourceAlpha" result="shadowOffsetOuter1" />
        ...
        <filter filterUnits="objectBoundingBox" height="165%" id="onykkikjuf" width="165%" x="-32.5%" y="-32.5%">
          <feOffset in="SourceAlpha" result="shadowOffsetOuter1" />
        ...
        <circle cx="30" cy="30" id="hk1g1gkosg" r="30" />
        <rect height="100" id="s8qmgx6uqb" rx="30" width="100" x="0" y="0" />
        <path d="M0 0L54 0 54 58 0 58z" id="pebwltarhd" />
      </defs>
            ...
            <g>
              <g>
                <g transform="translate(-595.000000, -174.000000) translate(510.000000, 100.000000) translate(145.000000, 114.000000) translate(0.000000, 20.000000)">
                  <use fill="#000" filter="url(#3fyl6e67sa)" xlinkHref="#s8qmgx6uqb" />
                  <use fill="#4CD964" xlinkHref="#s8qmgx6uqb" />
                </g>
                <g
                  filter="url(#zyr90pzvkc)"
                  transform="translate(-595.000000, -174.000000) translate(510.000000, 100.000000) translate(145.000000, 114.000000) translate(0.000000, 20.000000) translate(23.000000, 21.000000)"
                >
                  <g>
                    <mask fill="#fff" id="1kywbnpgwe">
                      <use xlinkHref="#pebwltarhd" />
                    </mask>
                    <path
              ...
              <g>
                <g transform="translate(-595.000000, -174.000000) translate(510.000000, 100.000000) translate(145.000000, 114.000000) translate(71.000000, 0.000000)">
                  <use fill="#000" filter="url(#onykkikjuf)" xlinkHref="#hk1g1gkosg" />
                  <use fill="#FFF" xlinkHref="#hk1g1gkosg" />
                </g>
                <g fill="#4CD964" fillRule="nonzero">
                  <path
                    ...
                    transform="translate(-595.000000, -174.000000) translate(510.000000, 100.000000) translate(145.000000, 114.000000) translate(71.000000, 0.000000) translate(15.000000, 20.000000)"
                  />
                </g>
              </g>
            </g>
