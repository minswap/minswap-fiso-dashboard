...
export const PARTNERS: Partner[] = [
  ...
  },
  {
    ...
    ticker: 'FUNGI',
    description:
      'FUNGI pool here. We donate 10% of our block rewards to different research initiatives, projects, and organizations that utilize fungi and mushrooms in innovative ways to help people and the planet at large.',
    twitter: 'fungipool',
  },
  {
