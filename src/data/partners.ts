...
export const PARTNERS: Partner[] = [
  ...
  },
  {
    ...
    ticker: 'SOLIA',
    description:
      'Let\'s reforest Amazonia with us !',
    twitter: 'PoolSolia',
  },
  {
  ...
  },
  {
    ...
    ticker: 'NOVA',
    description: 'The mission of NOVA Pool Germanys is to add value to the Cardano network by providing the German and English speaking Cardano community with educational videos about Cardano and digital artwork. So that knowledge and passion is shared with the new and existing Cardano users.',
    twitter: 'NOVA_Pool',
  },
  {
    id: 'c2b8bff5160dd75149f2cae0955698550e8cf0d390025b26a9508a3e',
    ticker: 'QCPOL',
    description: 'We’re two friends running a pool on bare-metal servers hosted in Québec. We want to build a community around Cardano for Quebecers (so mainly French stuff). We love poutine! P.S.: Our pledge is currently 15k, but will be upgraded to 20k in the next epoch (280).',
    twitter: 'QCPOLstakepool',
  },
  {
    id: 'eb6e1949ef2e1f2cdb9b041d2a4b86d4d837798ab3ddfe53cc4cafe4',
    ticker: 'ADATA',
    description: 'Promote the Cardano community providing analytics services. Our pool analytics API is a free of charge service available to the SPO and Cardanians ',
    twitter: 'ADApoolData',
  },
  {
    id: 'b2d1c479ce496d5be21cb68e95dae7342937c631488c47161d408f39',
    ticker: 'TREE',
    description: 'AdaTree has been operating since the beginning of Shelley and produced the first block in epoch 212 with a total of 152 blocks to date at 5.66% lifetime ROA. We\'ve also donated well over 2000 ADA total to websites that supports Cardano (pool.pm, Cardanoscan, Adapools, Pooltool) and our delegators.',
    twitter: 'ADATreePool',
  },
  {
  ...
  },
  {
    ...
    ticker: 'ALPCH',
    description: 'Alpen Cardano try to improve our nature with focus in the mountains. Our mission is contribute with organisations that prevent the destruction of the environment.',
    twitter: 'Mikelalpch',
  },
  {
    id: '91991d9238f3f270a46fc237acc3abcdf2456ff163c1639951d75d15',
    ticker: 'COINZ',
    description: 'Professional run pool by Cloud Solutions architect, security is top of mind. I donate 10% to Save The Children when we make a block. I am also working with my high school teacher reaching out to help continuation school students think beyond their current situation.',
    twitter: 'adacoinz',
  },
  {
  ...
  },
  {
    ...
    ticker: 'FUNGI',
    description: 'FUNGI pool here. We donate 10% of our block rewards to different research initiatives, projects, and organizations that utilize fungi and mushrooms in innovative ways to help people and the planet at large.',
    twitter: 'fungipool',
  },
  {
    id: '6e244c629b648b065ca4854ea7f8fb9838be54f688a5ee005074bdba',
    ticker: 'JUST',
    description: 'JUST pool is based in Australia for better decentralisation and active in Project Catalyst and Plutus Pioneers program (under different names). We have been involved since the start of the ITN and planning to build and educate on Cardano, once we complete the Plutus course. Cheers.',
    twitter: 'JustStakingADA',
  },
  {
    id: '381ad61d5031c2a570c268d2f018bfb65c6eb7e32e535a58384f9a21',
    ticker: 'ALFA',
    description: 'Alfa Pool is a professional operated high performance Baremetal Node with cloud Relays. We support ADA decentralization. New pool registered on epoch 271, we plan to donate at Greek charity organisations and other various projects once we establish enough staking to mint at least 1 block per epoch.',
    twitter: 'AlfaCardanoPool',
  },
  {
    id: '96553a437b99271fdcaa30c279e432224342e88147741db73872f03c',
    ticker: 'YOADA',
    description: 'We hare here for a better decentralization of cardano and having 0% margin to let our delegators get the most rewards.',
